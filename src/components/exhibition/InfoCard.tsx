...
function InfoCard({
  ...
  return (
    <section
      className={`fixed top-1/2 z-30 w-[420px] ${isDark ? '' : ''}`}
      style={{
        right: '48px',
    ...
    >
      ...
      >
        ...
        {/* 卡片内容 */}
        <div className={`${glassClass} p-5 rounded-2xl select-none min-h-[420px] ${isDark ? 'border-l border-t border-white/10 shadow-2xl' : 'border-white/40 shadow-xl'}`}>
          {isLoading ? (

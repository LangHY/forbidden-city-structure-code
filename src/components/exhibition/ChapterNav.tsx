...
function ChapterNav({
  ...
  // 检测 activeId 变化，触发聚焦动画
  useEffect(() => {
    if (activeId && activeId !== prevActiveId.current) {
      setFocusFlash(true);
      const timer = setTimeout(() => setFocusFlash(false), 600);
    ...
    >
      ...
      >
        {chapters.map((chapter, index) => {
          ...
          // 聚焦动画：选中项刚切换时的脉冲
          const showFocusPulse = isActive && focusFlash;
          ...
          return (
            ...
            >
              ...
              {/* 指示点 */}
              <div
                className={`rounded-full transition-all duration-350 relative ${
              ...
              >
                ...
                {showFocusPulse && (
                  <div
                    ...
                    style={{
                      border: `2px solid ${isDark ? 'rgba(251,191,36,0.6)' : 'rgba(74,124,89,0.5)'}`,
                      animation: 'dotPing 0.6s ease-out forwards',
                    }}
                  />
                )}
              </div>
              ...
              <span
                ...
                style={{
                  ...
                  textShadow: isActive
                    ? (isDark ? '0 0 20px rgba(251,191,36,0.3)' : '0 0 20px rgba(74,124,89,0.3)')
                    : 'none',
                }}
              >
                {chapter.label}
